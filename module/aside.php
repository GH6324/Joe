...
<aside class="joe_aside">
	<section class="joe_aside__item author">
		...
		<div class="user">
			...
			<a class="link" target="_self" href="<?php $this->options->JAside_Author_Link() ?>" rel="noopener noreferrer nofollow"><?php $this->options->JAside_Author_Nick ? $this->options->JAside_Author_Nick() : ($this->authorId ? $this->author->screenName() : $this->user->screenName()); ?></a>
