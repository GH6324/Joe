...
<?php endif; ?>
<?php if ($this->fields->reference == null) : ?>
<div class="joe_detail__copyright">
    <div class="content">
        <div class="item">
        ...
        <div class="item">
            ...
            <span>本文链接：</span>
            <span class="text">
                <a class="link" href="<?php $this->permalink() ?>" rel="noopener noreferrer nofollow"><?php $this->permalink() ?></a>
            </span>
        </div>
        <div class="item">
            <svg class="icon" width="20" height="20" viewBox="0 0 1024 1024">
...
<div class="joe_detail__copyright">
  <div class="content">
    ...
    <div class="item">
      ...
      <span>原文链接：</span>
      <span class="text">
        <a class="link" href="<?php echo $this->fields->reference; ?>" target="_blank" rel="noopener noreferrer nofollow"><?php echo $this->fields->reference; ?></a>
      </span>
    </div>
  </div>
</div>
